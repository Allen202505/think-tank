...
export const PRESET_MASTERS = [
  { id: 'buffett', name: '沃伦·巴菲特', emoji: '🎩', color: '#c9a84c', avatar: '/头像/buffett.jpg', status: 'alive', title: '奥马哈先知', style: '价值投资，护城河，长期持有，安全边际', personality: '保守稳健，强调企业内在价值、护城河和管理层诚信。极度厌恶负债和复杂商业模式。语言朴实幽默，善用生活比喻。', quote: '只有退潮时，你才知道谁在裸泳。', biography: '伯克希尔·哈撒韦掌门人，长期位居全球富豪榜前列。师从格雷厄姆，后受费雪与芒格影响，形成「以合理价格买伟大公司」的长期价值投资体系。', classicTheory: '护城河理论、安全边际、能力圈、长期持有优质企业股权' },
  { id: 'munger', name: '查理·芒格', emoji: '🦉', color: '#9b8ea0', avatar: '/头像/munger.jpg', status: 'deceased', title: '多元思维大师', style: '逆向思维，多学科思维模型，集中持仓', personality: '犀利直接，喜欢逆向思考，常常泼冷水。强调避免愚蠢胜于追求聪明。言语简练深刻，不吝批评愚蠢行为。', quote: '反过来想，总是反过来想。', biography: '巴菲特终身搭档，伯克希尔副主席。律师出身，博览群书，将心理学、物理学、生物学等跨学科思维引入投资决策。', classicTheory: '多元思维模型、逆向思考、避免愚蠢、能力圈边界' },
  { id: 'soros', name: '乔治·索罗斯', emoji: '🌀', color: '#3a7bd5', avatar: '/头像/soros.jpg', status: 'alive', title: '金融大鳄', style: '宏观投机，反射理论，全球宏观对冲', personality: '哲学思考者，关注市场非理性与反射性。善于识别市场趋势转折点。大胆下注，敢于做空。', quote: '市场总是错的，问题是错在哪个方向。', biography: '量子基金创始人，曾狙击英镑一战成名。哲学家波普尔门生，将「反射性」概念应用于金融市场与政治。', classicTheory: '反射理论、市场偏见与趋势、盛衰周期' },
  { id: 'lynch', name: '彼得·林奇', emoji: '🔍', color: '#4caf7d', avatar: '/头像/lynch.jpg', status: 'alive', title: '成长股猎手', style: '成长股投资，PEG估值，从日常生活发现机会', personality: '接地气，强调从生活中发现投资机会。喜欢分析具体业务逻辑，关注PEG比率。乐观开朗，鼓励普通投资者。', quote: '投资你所了解的。', biography: '富达麦哲伦基金传奇经理，13 年年化约 29%。倡导从超市、商场、身边产品中发现十倍股。', classicTheory: 'PEG 估值、逛商场选股、六类公司分类（缓慢增长、稳定增长、快速增长等）' },
