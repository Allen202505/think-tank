...
> 最后更新：2026-09-16（芒格教你读财报接入 A 股财报侦查诊断）
...
- 公司、报告期、一句话经营模式和本期重点。
- 6-10 条诊断项，按 P0/P1/P2 排序。
- 状态：🟢正常、🟡关注、🟠明显异常、🔴高风险信号、⚪数据不足。
- 每项包含：诊断领域、指标、当前/趋势、核心发现、下一步验证、来源。
- 底部给出「本次最值得继续调查的 3 个问题」，可直接举手追问芒格。
- 原「系统数据核验」收进诊断清单内部，默认折叠，避免重复占用页面。
