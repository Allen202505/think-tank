...
export const metadata = {
  title: '大师吵股 - AI投资大师智囊团：大师PK、巴菲特早餐新闻解读、财报解读、缠论短线、大师选股池、纳瓦尔知识学堂、鱼大基础面研究',
  description: '大师吵股汇聚巴菲特、芒格、寒武纪的鳄鱼、段永平等投资大师，AI 模拟大师辩论（大师PK）、新闻事件穿透解读（巴菲特的早餐）、财报深入浅出解读（芒格教你读财报）、缠论短线分析（缠中说禅）、大师选股池与区间统计、纳瓦尔知识学堂（财务投资知识点讲解+每日知识点）、鱼大基础面研究（央企+周期底部基础面研究+选股10条评分），为投资决策提供多角度参考。',
  keywords: '大师吵股,大师PK,巴菲特早餐,新闻解读,事件穿透,芒格读财报,财报解读,缠论,短线分析,大师选股池,纳瓦尔,知识学堂,财务知识点,投资知识点,每日知识点,投资大师,巴菲特,芒格,段永平,寒武纪的鳄鱼,鱼大基础面研究,基础面研究,选股10条,央企,周期底部,投资决策,AI投资顾问',
  authors: [{ name: '大师吵股团队' }],
  creator: '大师吵股',
  publisher: '大师吵股',
  ...
  openGraph: {
    ...
    description: 'AI 模拟巴菲特等投资大师辩论与解读：大师PK、新闻事件穿透解读、财报解读、缠论短线、大师选股池、纳瓦尔知识学堂、鱼大基础面研究',
    url: '/',
    siteName: '大师吵股',
    locale: 'zh_CN',
    type: 'website',
  ...
  twitter: {
    ...
    title: '大师吵股 - 世界投资大师智囊团',
    description: '大师PK、巴菲特早餐新闻解读、财报解读、缠论短线、大师选股池、纳瓦尔知识学堂，AI 模拟大师智慧助力决策',
    images: ['/og-image.png'],
  },
  robots: {
    index: true,
