...
- 服务类目：已设置主营“教育服务-教育信息展示”，状态“已通过”；如审核要求，可补充“工具-信息查询”。
...
- 2026-09-19：小程序基础信息、头像、介绍、服务类目和主营类目已提交，类目已通过。
- 2026-09-19：云环境 `cloudbase-d0govchp716d4e94d` 已创建，云函数 `mini-api` 已部署并配置签名密钥。
- 2026-09-19：Vercel Production 已配置签名密钥；生产 API 无签名请求返回 401，签名请求返回 200。
- 2026-09-19：开发者工具完成编译，版本 `1.0.0` 已上传。
- 2026-09-19：《多棱镜笔记小程序隐私保护指引》已提交。
- 2026-09-19：版本 `1.0.0` 已提交微信团队审核，当前状态为“审核中”。
- 2026-09-20：小程序备案已提交，后台状态为“审核中”；管理员实名验证、主体信息、服务内容、前置审批和服务说明已完成。
- 2026-09-20 21:52：版本 `1.0.0` 已发布为线上版本。
- 2026-09-21：复核 AppID、首页路径和线上版本无误；已生成首页小程序码 `submission/miniprogram-code-pages-home.jpg`。
- 当前可见性：小程序备案审核中；微信认证未完成，因此微信搜索/分享能力受限，但发布和小程序码访问不受代码审核影响。
